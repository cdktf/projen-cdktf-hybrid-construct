...
export class Eks extends TerraformModule {
  ...
  public constructor(scope: Construct, id: string, config: EksConfig = {}) {
    ...
    this.nodeSecurityGroupNtpIpv4CidrBlock = config.nodeSecurityGroupNtpIpv4CidrBlock;
    this.nodeSecurityGroupNtpIpv6CidrBlock = config.nodeSecurityGroupNtpIpv6CidrBlock;
